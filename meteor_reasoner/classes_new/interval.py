...
class Interval:
    def __init__(self, left_value : Decimal, right_value : Decimal, left_open : bool, right_open : bool):
        """
    ...
    def is_valid_interval(left_value, right_value, left_open, right_open):
        ...
        if left_value == right_value and left_open and right_open:
            ...
            return False
        elif left_value in [Decimal("-inf"), Decimal("inf")] and not left_open:
            return False
        elif right_value in [Decimal("-inf"), Decimal("inf")] and not right_open:
            return False
    ...
    def __str__(self):
        ...
        if self.left_open:
            ...
            str_output += "["
        if self.left_value in [Decimal("-inf")]:
            str_output += "-inf"
        elif self.left_value in [Decimal("inf")]:
            str_output += "+inf"
        else:
        ...
        if self.right_value in [Decimal("-inf")]:
            str_output += "-inf"
        elif self.right_value in [Decimal("inf")]:
            str_output += "+inf"
        else:
    ...
    def sub(v1, v2):
        ...
        """
        if v1.left_value in [Decimal("-inf"), Decimal("inf")]:
            left_value = v1.left_value
        else:
            left_value = v1.left_value - v2.right_value
        if v1.right_value in [Decimal("-inf"), Decimal("inf")]:
            right_value = v1.right_value
        else:
        ...
        if left_value == Decimal("-inf") or (v1.left_open or v2.right_open):
            left_open = True

        if right_value == Decimal("inf") or (v1.right_open or v2.left_open):
            right_open = True
    ...
    def circle_sub(v1, v2):
        ...
        if left_value == Decimal("-inf") or (v1.left_open and not v2.left_open):
            left_open = True

        if right_value == Decimal("inf") or (v1.right_open and not v2.right_open):
            right_open = True
    ...
    def add(v1, v2):
        ...
        if left_value == Decimal("-inf") or (v1.left_open or v2.left_open):
            left_open = True

        if right_value == Decimal("inf") or (v1.right_open or v2.right_open):
            right_open = True
    ...
    def circle_add(v1, v2):
        ...
        if left_value == Decimal("-inf") or (v1.left_open and not v2.right_open):
            left_open = True

        if right_value == Decimal("inf") or (v1.right_open and not v2.left_open):
            right_open = True
